...
export const RideCard = (props) => {
    ...
    return (
        <div key={ride.id} className="col-md-12 ride-card">
            <Link to={`/rides/details/${ride.id}`} className="text-decoration-none">
                    ...
                    <div className="row justify-content-between align-items-start">
                        <div className="col-md-8">
                            ...
                            <div className="d-flex align-items-center gap-3">
                                <p>
                                    <img src='/assets/defualt-profile-pic.png' alt="Driver picture" width="40" height="40" className="profile-pic" />
