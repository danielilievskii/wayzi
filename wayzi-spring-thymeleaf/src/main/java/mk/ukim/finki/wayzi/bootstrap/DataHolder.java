...
public class DataHolder {
    ...
    public DataHolder(StandardUserRepository standardUserRepository,
                      AdminUserRepository adminUserRepository,
                      VehicleRepository vehicleRepository,
                      LocationRepository locationRepository, RideRepository rideRepository, RideStopRepository rideStopRepository,
    ...
    public void init() {
        ...
        if (this.standardUserRepository.count() == 0) {
            standardUsers.add(new StandardUser("dilievski54@gmail.com", passwordEncoder.encode("12345"), "Daniel Ilievski"));
            standardUsers.add(new StandardUser("gingermenhd@gmail.com", passwordEncoder.encode("12345"), "Charlton Howards"));
            this.standardUserRepository.saveAll(standardUsers);
        }

        adminUsers = new ArrayList<>();
        if(this.adminUserRepository.count() == 0) {
            adminUsers.add(new AdminUser("admin@admin.com", "admin", passwordEncoder.encode("admin")));
            this.adminUserRepository.saveAll(adminUsers);
        }
...
//            locations.add(new Location("Cheshinovo i Obleshevo",null));
        ...
        if(this.rideRepository.count() == 0) {
            rides.add(new Ride(locations.get(0), LocalDateTime.now(), locations.get(1), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            ...
            rides.add(new Ride(locations.get(15), LocalDateTime.now().plusHours(100), locations.get(30), LocalDateTime.now().plusHours(100).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.get(16), LocalDateTime.now(), locations.get(12), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.get(5), LocalDateTime.now(), locations.get(1), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.get(17), LocalDateTime.now(), locations.get(11), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.get(0), LocalDateTime.now(), locations.get(15), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.get(18), LocalDateTime.now(), locations.get(1), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.get(13), LocalDateTime.now(), locations.get(17), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.get(12), LocalDateTime.now(), locations.get(7), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.get(11), LocalDateTime.now(), locations.get(6), LocalDateTime.now().plusHours(1).plusMinutes(30), standardUsers.get(0), vehicles.get(0), 4, 200, RideStatus.CONFIRMED));
            rides.add(new Ride(locations.getLast(), LocalDateTime.now().plusHours(1), locations.get(12), LocalDateTime.now().plusHours(4), standardUsers.get(0), vehicles.get(1), 2, 150, RideStatus.PENDING));
        ...
        if(this.rideStopRepository.count() == 0) {
            rideStops.add(new RideStop(rides.get(1), locations.get(10), LocalDateTime.now().plusHours(1), 1));
            rideStops.add(new RideStop(rides.get(1), locations.get(31), LocalDateTime.now().plusHours(2), 2));
